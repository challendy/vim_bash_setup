...
" Typical Prompt
silent execute "syn match ConquePromptLine '" . g:Term_PromptRegex . ".*$' contains=ConquePrompt,ConqueString oneline"
silent execute "syn match ConquePrompt '" . g:Term_PromptRegex . "' contained oneline"
